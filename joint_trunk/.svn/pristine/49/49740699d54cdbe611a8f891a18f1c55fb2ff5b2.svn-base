...
use Joint\Package\Helper\OfficeDBHelper;
use Joint\Package\Helper\RecruitDBHelper;
use Joint\Package\Helper\AdministrationDBHelper;
use Joint\Package\Helper\CoreDBHelper;
use Joint\Package\Helper\HrDBHelper;
use Joint\Package\Helper\RoutineDBHelper;
use Joint\Package\Helper\StaffDBHelper;
use Joint\Package\Helper\WorkerDBHelper;
use Joint\Package\Helper\CrabDBHelper;
...
class DbAdapter implements \Pixie\DatabaseAdapter
{
    ...
    protected function conn()
    {
        switch($this->database)
        {
            ...
            case 'crab':
                return CrabDBHelper::getConn();
            case 'office':
                return OfficeDBHelper::getConn();
            default:
