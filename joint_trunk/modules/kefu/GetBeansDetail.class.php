 ...
 * @since 2015-09-16
 * wiki http://interfaces.meiliworks.com/show/interface?id=1631&work_id=15
 */

class GetBeansDetail extends \Joint\Modules\Common\BaseModule {
    ...
    public function run(){
        ...
        $data = MemberInfo::getInstance()->getBeansDetail($this->params);
        if ($data === FALSE) {
