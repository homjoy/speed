    ...
    <form id="searchForm" class="form-inline  form-horizontal" method="POST" role="form" action="/itserver/vpn">
        ...
        <div class="table-container">
            ...
            <tr>
                ...
                <td>{$v['status']}</td>
                  <td >
                    <a class="btn btn-sm  btn-warning update_vpn_btn" data-yy="1" data-type={$v['type']} data-login_name="{$v['login_name']}"
...
DOC;
            ...
            <tr>
                ...
                <td>{$v['status']}</td>
                <td >
                    <a class="btn btn-sm btn-disabled" title="禁用"><span class="glyphicon glyphicon-log-in rm-disable"></span>已禁用
                    </a
                </td>
            </tr>
DOC;
            ...
            <div class="modal-body">
                <form  id="updateForm" class="form-horizontal">
                    <div class="form-group">
                        <label for="login_name" class="col-sm-2 control-label">VPN</label>
                        <div class="col-sm-10">
