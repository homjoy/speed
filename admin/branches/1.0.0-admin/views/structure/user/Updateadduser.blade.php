...
<div class="tab-pane fade in active" id="user">
    ...
    <form  id="userForm" class="form-inline  form-horizontal" role="form" >
        ...
        <div class="row">
            ...
            <div class="col-lg-2">
                <input   type="text"   class="form-control form-input input-xlarge"  @if (!isset($data['user_id'])|| empty($data['user_id'])) ajaxurl="/itserver/ajax_check_mail" @endif name="mail" id = 'mail' datatype="*" errormsg="不能为空" value="{{ $data['mail'] or '' }}">
                <span class="Validform_checktip"></span>
            </div>
...
<div class="tab-pane fade" id="pwdEdit">
    ...
    <form  id="pwdForm" class="form-inline  form-horizontal" role="form" >
        ...
        <div class="row">
            ...
            <label class="control-label col-lg-3" for="">mail密码:</label>
            <div class="col-lg-2">
    ...
    <div class="password_notice" style="color: #d16b8e">
        <p><span>密码由speed系统自动生成并下发到用户手机</span></p>
