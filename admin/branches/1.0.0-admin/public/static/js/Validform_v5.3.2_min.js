    ...
    a.util = {dataType: {"*": /[\w\W]+/, "*6-16": /^[\w\W]{6,16}$/, n: /^\d+$/, "n6-16": /^\d{6,16}$/, s: /^[\u4E00-\u9FA5\uf900-\ufa2d\w\.\s]+$/, "s6-18": /^[\u4E00-\u9FA5\uf900-\ufa2d\w\.\s]{6,18}$/, p: /^[0-9]{6}$/, m: /^13[0-9]{9}$|14[0-9]{9}|15[0-9]{9}$|17[0-9]{9}$|18[0-9]{9}$/, e: /^\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*$/, url: /^(\w+:\/\/)?\w+(\.\w+)+.*$/}, toString: Object.prototype.toString, isEmpty: function (k) {
        ...
        if (q && !a.util.isEmpty.call(d(this), k) && !n) {
            ...
            var p = {type: "POST", cache: false, url: q, data: "param=" + encodeURIComponent(k) + "&name=" + encodeURIComponent(d(this).attr("name")), success: function (x) {
                if (d.trim(x.code) == "200") {
                    m[0].validform_valid = "true";
                    x.info && m.attr("sucmsg", x.data);
                    if((typeof x.data=='string') && x.data.constructor==String){
                        var show_speed_msg = x.data;
                    }else{
                        var show_speed_msg = e.r;
                    }
                    a.util.showmsg.call(v, m.attr("sucmsg") || v.data("tipmsg").r || show_speed_msg, o.tiptype, {obj: m, type: 2, sweep: o.tipSweep}, "bycheck");
                    ...
                    m[0].validform_valid = x.error_msg;
                    a.util.showmsg.call(v, x.error_msg, o.tiptype, {obj: m, type: 3, sweep: o.tipSweep});
                ...
                if (x.code == "200") {
                    if (x.responseText == "y") {
                        ...
                        u.success({status: "n", info: x.info})
                    }
                    return false
                }
