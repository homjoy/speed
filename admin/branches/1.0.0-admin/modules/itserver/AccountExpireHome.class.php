...
class AccountExpireHome extends BaseModule
{
    ...
    public function run()
    {
        ...
        if(is_array($this->params['account_type'])&&count($this->params['account_type'])==1){
            $this->params['account_type'] =array_pop($this->params['account_type']);
        }
    ...
    private function _init()
    {
        $this->rules = array(
            ...
            'status'=> array(
                'type'=>'multiId',
                'default'=>array_keys($this->status_type),
            ),
