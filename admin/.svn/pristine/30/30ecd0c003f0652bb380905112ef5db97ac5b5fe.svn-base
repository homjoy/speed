...
<div id="container" class="effect mainnav-lg  mainnav-fixed">
    ...
    <div class="boxed">
        ...
        <div id="content-container">
         ...
         <div id="page-content"  style="min-height:500px !important;"><div class="row"><div class="col-xs-12">@yield('content') </div> </div></div>
        ...
        <nav id="mainnav-container">
            <div id="mainnav">
                <div id="mainnav-shortcut"> <ul class="nav navbar-top-links pull-left"> <!--Navigation toogle button--> <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~--> <li class="tgl-menu-btn" data-original-title="" title=""> <a class="mainnav-toggle" href="#"><i class="glyphicon glyphicon-list"></i></a> </li> <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~--> <!--End Navigation toogle button--> </ul> </div>
    ...
    <!-- FOOTER -->
    <!--===================================================-->
    <footer id="footer"> <div class="hide-fixed pull-right pad-rgt">v2.0</div> <div class=" pull-right">  </div> <p class="pad-lft"> © MEILISHUO 2013-2016</p></footer>
    <!--===================================================-->
    <!-- END FOOTER -->
...
<script>
    $(function() {
        ...
        // console.log(urlList);
        var current_url = "@if(!empty($currentUrl)){{$currentUrl}}@endif";
