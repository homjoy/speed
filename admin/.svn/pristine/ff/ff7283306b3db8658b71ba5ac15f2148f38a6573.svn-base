...
<script>
    ...
    $("#add_btn").click(function(){
        ...
        if(v_id>0){
            ...
            var data = { v_id:v_id,  v_url : v_url, v_code:v_code, v_name:v_name, v_md5:v_md5, v_type:v_type};
        }else{
            var url = "/im/app/ajax_app_add";
            var data = { v_url : v_url, v_code:v_code, v_name:v_name, v_md5:v_md5, v_type:v_type};
        }
