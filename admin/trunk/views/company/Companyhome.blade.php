...
<!--                        <th class="col-xs-1">所在城市</th>-->
                    ...
                    @if (!empty($data))
                        ...
                        @foreach ($data as $t)
                            <tr>
                                <td>{{ $t['company_id'] or '' }}</td>
<!--                                <td>{{ $t['city_id'] }}</td>-->
                                <td>{{ $t['company_name'] or '' }}</td>
                                <td>{{ $t['company_address'] or '' }}</td>
                                <td>{{ $t['company_addr'] or '' }}</td>
                                <td>{{ $t['telephone'] or '' }}</td>
                                <td>{{ $t['fax'] or '' }}</td>
                                <td>{{ $t['status'] or '' }}</td>

                                <td>
                                    <a class="btn btn-sm btn-warning editBtn" type="button" data-toggle="modal"
                                       data-city_id="{{$t['city_id'] or ''}}"        data-fax="{{$t['fax'] or ''}}"   data-telephone="{{$t['telephone'] or ''}}"  data-company_addr="{{$t['company_addr'] or ''}}"   data-name="{{$t['company_name'] or ''}}"  data-status="{{$t['status'] or ''}}"   data-company_address="{{$t['company_address'] or ''}}"  data-id="{{$t['company_id'] or ''}}"><span
                                         class="glyphicon glyphicon-log-in rm-disable"></span>修改
                                    </a>
                                    <a class="btn btn-sm btn-danger  deleteBtn" type="button" data-toggle="modal"
                                       data-name="{{$t['company_name'] or ''}}"   data-city_id="{{$t['city_id'] or ''}}"   data-id="{{$t['company_id'] or ''}}"><span class="glyphicon glyphicon-remove rm-disable"></span>删除
                                    </a>
                                </td>
                        ...
                        <form  id="addForm" class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <select     class="form-control m_city_id" name='city_id'>
