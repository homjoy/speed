	...
	<table class="table table-striped">
		...
		<tbody>
			...
			<tr>
				...
				<td><a href="/auth/tree/permissions_add?role_id={{ $t['role_id'] }}" >查看</a></td>
				<td><a href="#" pid="{{ $t['role_id'] }}" class="edit_btn" data-toggle="modal" data-target="#cateModal">编辑</a></td>
			</tr>
