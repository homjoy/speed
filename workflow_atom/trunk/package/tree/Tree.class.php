...
class Tree  {
    ...
    private static $col = array('tree_id', 'tree_name', 'tree_url', 'status', 'parent_id','display_position');
    ...
    public function getDataList(array $params = array())
    {
        ...
        if (isset($params['display_position'])) {
            if (is_array($params['display_position'])) {
                $ret->whereIn('display_position', $params['display_position']);
            }else{
                $ret->where('display_position', '=', $params['display_position']);
            }
        }
