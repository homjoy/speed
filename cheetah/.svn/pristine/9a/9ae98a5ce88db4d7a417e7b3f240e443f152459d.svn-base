...
var controlFns = {
    ...
    , user: function (params) {
        ...
        var php = {
            ...
            //新手机验证码提交
            'update_user_private_info':'/account/update_user_private_info',
            //验证动态密钥
            'verify_mfa_code':'/auth/verify_mfa_code',
            //二维码手机验证
            'save_mfa_status':'/auth/save_mfa_status',
            'get_mfa_status':'/auth/get_mfa_status',
            'expire_verify':'/auth/verify_mfa_code',
            'send_login_verify': '/auth/send_sms_captcha'
        };
        this.ajaxTo(php[params]);
    }
    , it: function (params) {
    ...
    var php = {
        ...
        //办公用品
        //查询办公用品
        'supply_request':'/executive_supply/supply_request',
        //办公用品提交
        'supply_submit':'/executive_supply/supply_submit',
        //详情页面
        'supply_approve_request':'/executive_supply/supply_approve_request',
        //审批记录
        'supply_approve_list':'/executive_supply/supply_approve_list',
        //管理驳回
        'supply_status_change':'/executive_supply/supply_status_change',
        //管理员发放，通知领取
        'supply_output':'/executive_supply/supply_output',

        //固定资产
        //物品种类
        'assets_request':'/executive_assets/assets_request',
        //固定资产提交
        'assets_submit':'/executive_assets/assets_submit',
        //详情页
        'assets_approve_request':'/executive_assets/get_approve_request',
        //管理信息初始化
        'manager_edit_request':'/executive_assets/manager_edit_request',
        //管理编辑提交
        'manager_submit':'/executive_assets/manager_submit',
        //审批记录
        'approve_assets_info':'/executive_assets/approve_assets_info',
        //管理驳回
        'assets_status_change':'/executive_assets/assets_status_change',
        //通知领取
        'assets_output':'/executive_assets/assets_output',
