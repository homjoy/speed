fml.define('speed/time/my', ['jquery', 'plugin/moment', 'plugin/bootstrap/datetimepicker', 'plugin/bootbox', 'plugin/artTemplate','speed/time/modal','speed/time/wizard'], function (require, exports) {
    "use strict";
    ...
    $(document).on("click", ".btn-cancel", function (e) {
        ...
        var type = dl.hasClass('meeting') ? "meeting" : 'time';
        var id = self.attr("data-id");
        if (!id) {
            return;
        }
        Modal.cancel(type, id,function(success){
            if(success){
                loadList();
            }
        });
    ...
    $(document).on('click', ".btn-decline", function (e) {
        ...
        Modal.decline(type, id , function(success){
            if(success){
                loadList();
            }
        });
    ...
    $(document).on("click", ".btn-edit", function (e) {
        ...
        Modal.update(type,id,function(success){
            if(success){
                loadList();
            }
        });
