fml.define("fms/my/approval/reimburse",['jquery','component/notify','component/approval'],function(require,exports){
    ...
    var option={
        ...
        +'</form>',
        reimburseAddClaim:'<form class="form-horizontal form-agree">'
        ...
        +'<div class="form-group"><label class="col-lg-3 col-sm-3 col-xs-3 control-label">理由</label><div class="col-lg-8 col-sm-8 col-xs-8"><textarea class="form-control reason" name="reason" rows="3"></textarea> </div></div>'
        +'</form>',
        isStruss2:true,
        timeSearch:true,
        departSearch:false,
