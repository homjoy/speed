fml.define('plugin/bootstrap/datetimepicker',['jquery'],function(require,exports){
	"use strict";
	...
	!function( $ ) {
		...
		var Datetimepicker = function(element, options) {
			...
			this.update();
			this.showMode();
			//this.setStartHour = (options.setStartHour == 'allday')? 0:8;
			// this.setEndHour = (options.setEndHour == 'allday')? 24:20;

			this.setStartHour = (options.setStartHour||8);
			this.setEndHour = (options.setEndHour||24);
		...
		Datetimepicker.prototype = {
			...
			fill: function() {
				...
				for (var i=this.setStartHour;i<this.setEndHour;i++) {
