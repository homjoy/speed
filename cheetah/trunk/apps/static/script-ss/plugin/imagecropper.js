fml.define('plugin/imagecropper', [], function () {
    "use strict";
	...
	c.prototype._init = function() {
		var a = Math.min(this.width / this.image.width, this.height / this.image.height);
	...
	c.prototype._mouseHandler = function(a) {
		if (a.type == "mousemove") {
			...
			this.mouseX = a.pageX - b.left;
			this.mouseY = a.pageY - b.top;
