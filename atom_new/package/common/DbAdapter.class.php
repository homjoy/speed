...
use Atom\Package\Helper\OfficeDBHelper;
use Atom\Package\Helper\RecruitDBHelper;
use Atom\Package\Helper\AdministrationDBHelper;
use Atom\Package\Helper\CoreDBHelper;
use Atom\Package\Helper\HrDBHelper;
use Atom\Package\Helper\RoutineDBHelper;
use Atom\Package\Helper\StaffDBHelper;
use Atom\Package\Helper\WorkerDBHelper;
use Atom\Package\Helper\CrabDBHelper;
use Atom\Package\Helper\ApprovalDBHelper;
...
class DbAdapter implements \Pixie\DatabaseAdapter
{
    ...
    protected function conn()
    {
        switch($this->database)
        {
            ...
            case 'approval':
                return ApprovalDBHelper::getConn();
            case 'office':
