...
class OrderVisitingCard extends BaseQuery{

    private static $col = array('order_id','user_id', 'task_id', 'job', 'english_job', 'english_name', 'we_chat', 'work_place', 'memo', 'status', 'create_time', 'update_time','name','mobile','mail','qq','output','output_manager','reject_reason');
