...
class DepartmentRelationTemp extends BaseQuery {
    ...
    {
        return 'department_relation_temp';
    }
    ...
    public function getDataList($params = array(), $offset = 0, $limit = 100)
    {
        ...
        return $builder->hash('depart_id')->offset($offset)->limit($limit)->get();
    }
    ...
    public function  updateById($params){
     ...
     public function insert($params) { //user_id并不是必须要有可以有代理role_id必须有 zhouhong edit
    ...
    public function insertAll() {
        $sql = 'insert into ' . self::tableName() . ' select * from department_relation';
