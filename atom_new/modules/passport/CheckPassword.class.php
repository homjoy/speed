...
class CheckPassword extends \Atom\Modules\Common\BaseModule {
    ...
    public function run() {
        ...
        //查询
        $result = Passport::getInstance()->complexMatch($queryParams['email'], $queryParams['oldpassword'], $queryParams['newpassword']);
