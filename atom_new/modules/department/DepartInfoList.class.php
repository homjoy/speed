 ...
 */
class DepartInfoList extends \Atom\Modules\Common\BaseModule{
    ...
    public function run() {
        ...
        $this->_init();
        $this->sample = DepartmentInfo::getFields();
        ...
        if ($ret === FALSE) {
            ...
            if( !empty($this->params['count'] )){
                ...
                $return =  Response::gen_success(Format::outputData($ret, $this->sample, TRUE));
            }
        }
