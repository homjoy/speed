 ...
 * @date 2015-09-15
 */
class DepartSubTempList extends \Atom\Modules\Common\BaseModule{
    ...
    public function run() {
        ...
        $ret = DepartmentSubTemp::model()->getDataList($this->params, $this->params['offset'], $this->params['limit']);
        if ($ret === FALSE) {
