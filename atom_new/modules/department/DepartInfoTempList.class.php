 ...
 */
class DepartInfoTempList extends \Atom\Modules\Common\BaseModule{
    ...
    public function run() {
        ...
        $ret = DepartmentInfoTemp::model()->getDataList($queryParams, $this->params['offset'], $this->params['limit']);
        if ($ret === FALSE) {
