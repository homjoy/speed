...
namespace Libs\Thrift\Protocol;
 ...
 * Protocol exceptions
 */
class TProtocolException extends \Libs\Thrift\TException {
  const UNKNOWN = 0;
...
abstract class TProtocol {
  ...
  static $TBINARYPROTOCOLACCELERATED = 'Libs\Thrift\Protocol\TBinaryProtocolAccelerated';
