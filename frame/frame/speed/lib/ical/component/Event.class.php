...
namespace Frame\Speed\Lib\Ical\Component;

use Frame\Speed\Lib\Ical\Component;
use Frame\Speed\Lib\Ical\PropertyBag;
...
class Event extends Component
{
    ...
    public function buildPropertyBag()
    {
        ...
        if( $this->repeat )
            $this->properties->set('RRULE', 'FREQ=' . $this->repeat);
    }
