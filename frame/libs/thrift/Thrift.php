 ...
 */
if (!isset($GLOBALS['THRIFT_ROOT_LIB'])) {
  $GLOBALS['THRIFT_ROOT_LIB'] = dirname(__FILE__);
}
include_once $GLOBALS['THRIFT_ROOT_LIB'].'/protocol/TProtocol.php';
include_once $GLOBALS['THRIFT_ROOT_LIB'].'/transport/TTransport.php';
